  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title col-lg-4 offset-lg-4 col-sm-4 offset-sm-4">Supprimer</h4>
      </div>
      ...
      <div class="modal-body">
        ...
        <button type="button" class="btn btn-primary col-lg-3 offset-lg-3 col-sm-3 offset-sm-3 closedModal">Annuler</button>
