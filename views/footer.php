    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
          ...
          <p class="copyright text-muted">Ce site est un projet lié à ma formation de DWJ avec Openclassrooms. Je me suis inspiré de l'écrivain Guillaume Musso et ai utilisé des éléments trouvés sur son <a href ="http://www.guillaumemusso.com/"> site.</a></p>
        </div>
      </div>
    </div>
  </div>
